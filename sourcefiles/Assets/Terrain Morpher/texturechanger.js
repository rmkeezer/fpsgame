...
function changeTexture(pos : Vector3)
{
	var g : int = Mathf.Lerp(0, xRes, Mathf.InverseLerp(0, tData.size.x, pos.x));
	var b : int = Mathf.Lerp(0, yRes, Mathf.InverseLerp(0, tData.size.z, pos.z));
