...
function makeCrater(pos : Vector3) 
{
	var x : int = Mathf.Lerp(0, xRes, Mathf.InverseLerp(0, tData.size.x, pos.x));
	var z : int = Mathf.Lerp(0, yRes, Mathf.InverseLerp(0, tData.size.z, pos.z));
