...
class DamageController extends MonoBehaviour
{
	...
	public var actorTextOffset : Vector3 = new Vector3(0,1.0f,0);
	...
	function Update()
	{
	    ...
	    if(actorText != null)
	    {
            ...
            var camDiff : Vector3 = actorText.transform.position - GameObject.Find("MainCamera").transform.position;
