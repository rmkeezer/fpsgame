...
public class EffectLayer : MonoBehaviour
{
    ...
    public int RenderType; //0 sprite 1 ribbon 2 fence
    ...
    //added 2012.5.6 have used by sprite for GUI Camera, but not used by ribbon trail yet.
    ...
    public void FindMyCamera()
    {
		...
		MyCamera = null;
        //Debug.LogError("can't find proper camera for this object's layer!");
    }
    ...
    public bool EmitOver(float deltaTime)
    {
        ...
        if (AvailableNodeCount == MaxENodes && !IsEmitByDistance)
        {
    ...
    public void SetArractionAffectorGoal(Transform goal)
    {
        ...
        {
            ArrayList affectorList = en.GetAffectorList();
